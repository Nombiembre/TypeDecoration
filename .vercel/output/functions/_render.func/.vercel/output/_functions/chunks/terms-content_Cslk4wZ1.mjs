...
const $$TermsContent = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$TermsContent;
  const lang = getLangFromUrl(Astro2.url);
  const data = await getCollection("terms", ({ slug }) => {
    return slug === lang;
  });
...
}, "/home/michi/dev/web/fiver/pixelthinkers/src/components/content/terms-content.astro", void 0);

export { $$TermsContent as $ };
