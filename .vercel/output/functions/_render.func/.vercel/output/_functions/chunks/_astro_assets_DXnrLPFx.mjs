...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      './astro/assets-service_XoVqVOaB.mjs'
    ).then(n => n.a0).catch((e) => {
...
}, "/home/michi/dev/web/fiver/pixelthinkers/node_modules/astro/components/Image.astro", void 0);
...
}, "/home/michi/dev/web/fiver/pixelthinkers/node_modules/astro/components/Picture.astro", void 0);
